...
//	    		startActivity(intent);
				...
				//Alternativ zum Starten einer neuen Activity hier finish() aufrufen und darin den Result zur�ckgeben.
				finish();
			}else{
			    ...
			    switch (id) {
			        ...
			        case 16908332:
			        	//DAS WIRD AUS irgendeinem Grund nicht ausgef�hrt. Darum in den if-Abfrage vorneweg verlagert.
